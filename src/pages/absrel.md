...
if (jsonUrl) {
  ...
  fetch(jsonUrl)
    ...
    .then(data => {
      ...
      if (data && data.MLE) {
        console.log('[aBSREL DEBUG] Setting resultsJson from URL data');
  ...
  try {
    ...
    if (data && data.MLE) {
      console.log('[aBSREL DEBUG] Setting resultsJson from parameter data');
      resultsJson.value = data;
    } else {
  ...
  if (localData) {
    ...
    try {
      ...
      if (data && data.MLE) {
        console.log('[aBSREL DEBUG] Setting resultsJson from localStorage');
        resultsJson.value = data;
      } else {
...
window.addEventListener(
  ...
  (event) => {
    ...
    if (
      ...
      console.log('[aBSREL DEBUG] Setting resultsJson from postMessage data');
      ...
      if (event.data.data && event.data.data.MLE) {
        console.log('[aBSREL DEBUG] Setting resultsJson from data-response');
        resultsJson.value = event.data.data;
      } else {
