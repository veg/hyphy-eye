...
if (jsonUrl) {
  ...
  fetch(jsonUrl)
    ...
    .then(data => {
      ...
      if (data && data.MLE) {
        console.log('[NRM DEBUG] Setting results_json from URL data');
  ...
  try {
    ...
    if (data && data.MLE) {
      console.log('[NRM DEBUG] Setting results_json from parameter data');
      results_json.value = data;
    } else {
  ...
  if (localData) {
    ...
    try {
      ...
      if (data && data.MLE) {
        console.log('[NRM DEBUG] Setting results_json from localStorage');
        results_json.value = data;
      } else {
...
window.addEventListener(
  ...
  (event) => {
    ...
    if (
      ...
      console.log('[NRM DEBUG] Setting results_json from postMessage data');
      ...
      if (event.data.data && event.data.data.MLE) {
        console.log('[NRM DEBUG] Setting results_json from data-response');
        results_json.value = event.data.data;
      } else {
